...
class Solution {
    ...
    merge(nums1, m, nums2, n) {
        // complete the placeholders with the value from 2nd array
        let j = 0
        for ( let i = m; i < m+n; i++) {
            nums1[i] = nums2[j]
            j++
...
console.log(solution.merge([10,20,20,40,0,0], 4, [1,2], 2)) // Output: [1,2,10,20,20,40]
console.log(solution.merge([0,0], 0, [1,2], 2)) // Output: [1,2]